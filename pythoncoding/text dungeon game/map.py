...
class Map:
    ...
    def generate_branch(self, x: int, y: int, room_count: int) -> list[tuple[int]]: #TODO: make it generate better maps, it currently looks too bunched up and ugly
        """
        ...
        for i in range(room_count):
            ...
            if i % 2 == 0: # every even room can sprout a new branch
    ...
    def generate_layout(self): #TODO: make the branch lengths scale off of the map size
        """
        ...
        main_branch_length: int = 5
        extra_branch_length: int = 5
